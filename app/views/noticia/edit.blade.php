	...
	@section('conteudo')
		...
		<div class="row">
			<div class="col-md-8">
					...
					<!--<form role="form">  value="{{ $noticia->texto }}"-->
						...
						<div class="form-group">
							...
							<textarea class="form-control" rows="3" id="texto" name="texto">{{$noticia->texto}}</textarea>
						</div>
						<div class="form-group">
						...
						<div class="form-group">
							...
							<div class="radio"> 
									...
									<label> <input type="radio" name="status" id="status" value="1" @if($noticia->status == 1) checked @endif > Exibir </label> 
							
									<label> <input type="radio" name="status" id="status" value="0" @if($noticia->status == 0) checked @endif > Não exibir </label>
